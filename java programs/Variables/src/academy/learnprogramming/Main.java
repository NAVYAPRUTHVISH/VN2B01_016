...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String prompt = ". Don't type in the answer, just press ENTER when you are ready to continue";
        ...
        scanner.nextLine();
        System.out.println("Divide the result by the numberyou originally thought of" + prompt);
        scanner.nextLine();
